...
const LandingPageCristian = () => {
 
const url = "/cristian-castellon/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbwCn5NYeX9AFVMScUD5pVr7bF37mmVkH_0P-e8oQ4GKmeUatsL7q17ilk1Uu33toglH/exec"
  return (
    <div >
      <div
...
export default LandingPageCristian;
