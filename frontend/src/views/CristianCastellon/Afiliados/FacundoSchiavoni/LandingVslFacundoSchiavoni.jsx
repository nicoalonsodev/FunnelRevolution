...
const LandingVslFacundoSchiavoni = () => {
...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/facundo-schiavoni/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "facundo-schiavoni"

const googleSheets = ""
const wppLink = "https://wa.me/+5491172151209?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491172151209"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslFacundoSchiavoni;
