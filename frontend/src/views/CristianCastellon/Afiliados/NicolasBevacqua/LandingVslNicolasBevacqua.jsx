...
const LandingVslNicolasBevacqua = () => {
...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/nicolas-bevacqua/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "nicolas-bevacqua"
const googleSheets = "https://script.google.com/macros/s/AKfycbyL1Jn-lbQFWCEN21j4ywN6qxiQ1RNMWLFTsxDyBGdzK7Twid9M7bi4s-GeCocXE_k3LA/exec"
const wppLink = "https://wa.me/+5492994555934?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5492994555934"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslNicolasBevacqua;
