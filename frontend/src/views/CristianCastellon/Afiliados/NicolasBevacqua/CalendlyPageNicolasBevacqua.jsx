...
const CalendlyPageNicolasBevacqua = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const calendlyLink = "https://calendly.com/nibrham-b/llamada-de-iniciacion-revolution";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageNicolasBevacqua;
