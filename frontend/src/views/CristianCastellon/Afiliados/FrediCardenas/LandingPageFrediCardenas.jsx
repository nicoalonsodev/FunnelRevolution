...
const LandingPageFrediCardenas = () => {
 
const url = "/fredi-cardenas/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbwyo_zcxsOvUPB4_2yS-19hlw30AGIqenuxxb8dBm5fQqk-a3hbRAohSMnKIEprG5pw/exec"
  return (
    <div >
      <div
...
export default LandingPageFrediCardenas;
