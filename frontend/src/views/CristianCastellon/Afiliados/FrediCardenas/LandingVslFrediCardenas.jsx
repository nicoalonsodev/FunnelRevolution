...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/fredi-cardenas/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "fredi-cardenas"

const googleSheets = "https://script.google.com/macros/s/AKfycbwyo_zcxsOvUPB4_2yS-19hlw30AGIqenuxxb8dBm5fQqk-a3hbRAohSMnKIEprG5pw/exec"
const wppLink = "https://wa.me/+5492805060484?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5492805060484"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslFrediCardenas;
