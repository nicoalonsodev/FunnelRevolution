...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/martin-acoria/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "martin-acoria"
const googleSheets = "https://script.google.com/macros/s/AKfycbzo1cLP625jro-3GdP2Bl3El39eCECMpIkbrAHqbakfoYKe00kJdoOmzL-Ur7TtkGyFHg/exec"
const wppLink = "https://wa.me/+5491138290489?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491138290489"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslMartinAcoria;
