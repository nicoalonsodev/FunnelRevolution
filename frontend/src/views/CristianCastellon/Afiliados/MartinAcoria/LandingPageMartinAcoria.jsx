...
const LandingPageMartinAcoria = () => {
 
const url = "/martin-vecchi/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbzo1cLP625jro-3GdP2Bl3El39eCECMpIkbrAHqbakfoYKe00kJdoOmzL-Ur7TtkGyFHg/exec"
  return (
    <div >
      <div
...
export default LandingPageMartinAcoria;
