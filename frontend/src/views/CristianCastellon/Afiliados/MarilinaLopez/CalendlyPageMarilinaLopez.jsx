...
const CalendlyPageMarilinaLopez = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const calendlyLink = "https://calendly.com/lopezburgosmarilina/llamada-de-iniciacion-en-revolution";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageMarilinaLopez;
