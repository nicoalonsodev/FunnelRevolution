...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/marilina-lopez/calendly";
const historyImages = [ img1, img2, img3, img4]
    const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "marilina-lopez"
const googleSheets = "https://script.google.com/macros/s/AKfycbwdgrQm2oDZGLNTHF0DLuZHKOyWqMo2ZgSWWp47dJ8xYhfqEwQwtW8qk2xPtpF4Xww2Kg/exec"
const wppLink = "https://wa.me/+5491155927639?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491155927639"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslMarilinaLopez;
