...
const LandingPageMarilinaLopez = () => {
 
const url = "/marilina-lopez/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbwdgrQm2oDZGLNTHF0DLuZHKOyWqMo2ZgSWWp47dJ8xYhfqEwQwtW8qk2xPtpF4Xww2Kg/exec"
  return (
    <div >
      <div
...
export default LandingPageMarilinaLopez;
