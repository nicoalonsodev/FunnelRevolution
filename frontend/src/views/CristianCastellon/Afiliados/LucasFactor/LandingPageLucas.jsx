...
const LandingPageLucas = () => {
 
const url = "/lucas-factor/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbyazU6SNfh2tqmDkXnJPd3qdfmBm_iH1glsHV_3_LAMEIWKYg4FWav2le7Tw2uWkGXV/exec"
  return (
    <div >
      <div
...
export default LandingPageLucas;
