...
const LandingPageJoaquinRolon = () => {
 
const url = "/joaquin-rolon/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbyXa5eWN8ISxft_oEL2M5DQblmLGblVfVe4hs_e7eZ7_6GaM424ySHuIXRkzIqBunxo/exec"
  return (
    <div >
      <div
...
export default LandingPageJoaquinRolon;
