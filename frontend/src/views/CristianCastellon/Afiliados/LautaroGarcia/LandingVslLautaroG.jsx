...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/lautaro-garcia/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "lautaro-garcia"
const googleSheets = "https://script.google.com/macros/s/AKfycbxnVR8lAsy1MnWwy_NicfqyvcvNgekmu2R7iJCetNbY-hT2I_lrhYDUZfjlnymffSFC/exec"
const wppLink = "https://wa.me/+5491133432960?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491133432960"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslLautaroG;
