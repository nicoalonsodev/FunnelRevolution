...
const LandingPageLautaroG = () => {
 
const url = "/lautaro-garcia/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbxnVR8lAsy1MnWwy_NicfqyvcvNgekmu2R7iJCetNbY-hT2I_lrhYDUZfjlnymffSFC/exec"
  return (
    <div >
      <div
...
export default LandingPageLautaroG;
