...
const LandingPageDiego = () => {
 
const url = "/diego-urquiza/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbzAWwZJ3z4Skq7C6XHsohrctHf8a8WifrJB89QGla_BD94hE3JphvbeTTni3tbt7pmv/exec"
  return (
    <div >
      <div
...
export default LandingPageDiego;
