...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/diego-urquiza/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "diego-urquiza"
const googleSheets = "https://script.google.com/macros/s/AKfycbzAWwZJ3z4Skq7C6XHsohrctHf8a8WifrJB89QGla_BD94hE3JphvbeTTni3tbt7pmv/exec"
const wppLink = "https://wa.me/+5491171727482?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491171727482"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslDiego;
