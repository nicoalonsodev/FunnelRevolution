...
const LandingPageAlfredoNeremberg = () => {
 
const url = "/adrian-machuca/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbzRVLw6wGoHEBrYCZOYRHKkCj4Msyx6P6OXcpzsci-if8rzxXfJoznJhEeS27J6jCnjmw/exec"
  return (
    <div >
      <div
...
export default LandingPageAlfredoNeremberg;
