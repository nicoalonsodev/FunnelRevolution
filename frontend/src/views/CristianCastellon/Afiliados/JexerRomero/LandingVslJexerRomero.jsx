...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/jexer-romero/calendly";
const historyImages = [ img1, img2, img3, img4]
    const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "jexer-romero"
const googleSheets = "https://script.google.com/macros/s/AKfycbyKurfjYtSsv-fM6e_hKb-CH0ntxE6vkXyBJ5VCGaN700CKNd_ZsYisVT95XXU9V5jEJA/exec"
const wppLink = "https://wa.me/+56961827149?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+56961827149"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslJexerRomero;
