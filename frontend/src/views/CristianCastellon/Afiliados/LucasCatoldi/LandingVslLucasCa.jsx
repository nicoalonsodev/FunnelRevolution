...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/lucas-catoldi/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "lucas-catoldi"
const googleSheets = "https://script.google.com/macros/s/AKfycbzry3EJGW5MOjP8QUocjtMFnQadlOHQNjrFcetqc4m1d_JK-tMJNwl3Ds-wblNhrRRr/exec"
const wppLink = "https://wa.me/+5491128853608?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491128853608"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslLucasCa;
