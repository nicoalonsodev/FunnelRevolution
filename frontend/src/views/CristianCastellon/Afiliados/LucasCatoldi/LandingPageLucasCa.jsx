...
const LandingPageLucasCa = () => {
 
const url = "/lucas-catoldi/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbzry3EJGW5MOjP8QUocjtMFnQadlOHQNjrFcetqc4m1d_JK-tMJNwl3Ds-wblNhrRRr/exec"
  return (
    <div >
      <div
...
export default LandingPageLucasCa;
