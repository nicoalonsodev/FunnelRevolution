...
const LandingPageLucasCeballos = () => {
 
const url = "/lucas-ceballos/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbxzGWYhpfTplwzb9GbJ6iwhJXwwra5s0GAuK38o_khSsoUfCR7OlQdcgOm7Yh94OBK2/exec"
  return (
    <div >
      <div
...
export default LandingPageLucasCeballos;
