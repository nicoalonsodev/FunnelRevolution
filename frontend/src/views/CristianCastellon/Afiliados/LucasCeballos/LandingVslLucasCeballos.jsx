...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/lucas-ceballos/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "lucas-ceballos"
const googleSheets = "https://script.google.com/macros/s/AKfycbxzGWYhpfTplwzb9GbJ6iwhJXwwra5s0GAuK38o_khSsoUfCR7OlQdcgOm7Yh94OBK2/exec"
const wppLink = "https://wa.me/+5492994169384?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5492994169384"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslLucasCeballos;
