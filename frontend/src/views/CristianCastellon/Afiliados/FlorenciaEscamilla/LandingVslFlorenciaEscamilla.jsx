...
const LandingVslFlorenciaEscamilla = () => {
...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/florencia-escamilla/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "florencia-escamilla"

const googleSheets = ""
const wppLink = "https://wa.me/+5491126073558?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491126073558"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslFlorenciaEscamilla;
