...
const LandingVslAgustinBenitez = () => {
...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/agustin-benitez/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "agustin-benitez"
const googleSheets = "https://script.google.com/macros/s/AKfycbzxh3aQP_ZuSUyTUcIoHJvKSnQUqvAJCrQgA9CffIaQTqKq4Y2LWfobn_Hw-kjwdlIP/exec"
const wppLink = "https://wa.me/+5491133001759?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491133001759"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslAgustinBenitez;
