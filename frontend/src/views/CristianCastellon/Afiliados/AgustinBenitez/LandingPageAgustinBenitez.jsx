...
const LandingPageAgustinBenitez = () => {
 
const url = "/agustin-benitez/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbzxh3aQP_ZuSUyTUcIoHJvKSnQUqvAJCrQgA9CffIaQTqKq4Y2LWfobn_Hw-kjwdlIP/exec"
  return (
    <div >
      <div
...
export default LandingPageAgustinBenitez;
