...
const LandingVslFranciscoChiap = () => {
...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/francisco-chiapero/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "francisco-chiapero"
const googleSheets = "https://script.google.com/macros/s/AKfycbx9DY15BRTb4yvuCbhMzvTpAfaSFfidteVDAOdyF_C4g1sgjk0swA4kw38ZUpMZR162/exec"
const wppLink = "https://wa.me/+5492993284015?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5492993284015"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslFranciscoChiap;
