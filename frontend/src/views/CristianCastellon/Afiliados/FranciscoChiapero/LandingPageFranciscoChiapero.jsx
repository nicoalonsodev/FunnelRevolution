...
const LandingPageFranciscoChiapero = () => {
 
const url = "/francisco-chiapero/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbx9DY15BRTb4yvuCbhMzvTpAfaSFfidteVDAOdyF_C4g1sgjk0swA4kw38ZUpMZR162/exec"
  return (
    <div >
      <div
...
export default LandingPageFranciscoChiapero;
