...
const CalendlyPageFranciscoChiapero = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const calendlyLink = "https://calendly.com/franchiape99/introduccion-a-revolution";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageFranciscoChiapero;
