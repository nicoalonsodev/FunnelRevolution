...
const LandingPageDamianCruciani = () => {
 
const url = "/damian-cruciani/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbzo_u7-jdTmcrj617M2UnfRCSlnEM7KL89XhkcccH_4dM0lsw4wOn9hSGu2Jkj952HbEQ/exec"
  return (
    <div >
      <div
...
export default LandingPageDamianCruciani;
