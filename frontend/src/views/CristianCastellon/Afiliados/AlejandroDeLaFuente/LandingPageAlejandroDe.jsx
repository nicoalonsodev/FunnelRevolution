...
const LandingPageAlejandroDe = () => {
 
const url = "/alejandro-de-la-fuente/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbxw14I1hHzXEevhW4iXMqpBOA-h-KUCeDo_dGvC3LFt2Skoxt1Jdb_HBnST7beawnXT/exec"
  return (
    <div >
      <div
...
export default LandingPageAlejandroDe;
