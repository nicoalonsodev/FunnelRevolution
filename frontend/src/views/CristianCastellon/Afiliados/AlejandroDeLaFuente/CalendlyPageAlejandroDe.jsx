...
const CalendlyPageAlejandroDe = () => {
  ...
  const calendlyLink = "https://calendly.com/delafuentedam/llamada-de-iniciacion-a-revolution";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageAlejandroDe;
