...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/alejandro-de-la-fuente/calendly";
...
const wppLink = "https://wa.me/+5491158585181?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491158585181"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslAlejandroDe;
