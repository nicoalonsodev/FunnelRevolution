...
const LandingPagePedroDantas = () => {
 
const url = "/pedro-dantas/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbzyQMA8Rx2oNmT0w1vW2cWNkuj0RywxRfoo9ZxWqd5HrzF4CcE-FCoaQpR-IQLnvN0olA/exec"
  return (
    <div >
      <div
...
export default LandingPagePedroDantas;
