...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/melina-troina/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "melina-troina"
const googleSheets = "https://script.google.com/macros/s/AKfycbypsFZjAvG5vU2WE9cEI6GpVNZoq0z7UXLusAGtxZvdz_AAQniCEm1PX6_A7yOVM9cudw/exec"
const wppLink = "https://wa.me/+5491170658698?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491170658698"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslMelinaT;
