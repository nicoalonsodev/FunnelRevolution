...
const LandingPageEzequielGrazina = () => {
 
const url = "/ezequiel-grazina/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbxRX_XrSd1EGbkHG_weh2cYA1nX6bWxAYI-MDMbsS6h-qDS0Zp8SNy9Mz2-curdS3hF/exec"
  return (
    <div >
      <div
...
export default LandingPageEzequielGrazina;
