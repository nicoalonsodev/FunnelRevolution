...
const LandingVslEzequielGrazina = () => {
...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/ezequiel-grazina/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "ezequiel-grazina"
const googleSheets = "https://script.google.com/macros/s/AKfycbxRX_XrSd1EGbkHG_weh2cYA1nX6bWxAYI-MDMbsS6h-qDS0Zp8SNy9Mz2-curdS3hF/exec"
const wppLink = "https://wa.me/+5491136902369?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491136902369"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslEzequielGrazina;
