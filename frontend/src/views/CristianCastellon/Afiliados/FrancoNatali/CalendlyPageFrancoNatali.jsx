...
const CalendlyPageFrancoNatali = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const calendlyLink = "https://calendly.com/francostefanonatali/llamada-de-iniciacion-revo";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageFrancoNatali;
