...
const LandingPageFrancoNatali = () => {
 
const url = "/franco-natali/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbx26ww343_4istIRD40QBNhteVlLi9cLHWTNxZ02JQ3_QeMIyCKLD2sSW6_XIU-iPND/exec"
  return (
    <div >
      <div
...
export default LandingPageFrancoNatali;
