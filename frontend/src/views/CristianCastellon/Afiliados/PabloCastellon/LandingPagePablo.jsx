...
const LandingPagePablo = () => {
 
const url = "/pablo-castellon/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbzEJF-sqUkJr-JMrpEbeVYQVd7ptafjvLHafqcMExzUY2ayWaHJr128psT2ON5FOpSb/exec"
  return (
    <div >
      <div
...
export default LandingPagePablo;
