...
const LandingVslNahuelIglesias = () => {
...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/nahuel-iglesias/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "nahuel-iglesias"

const googleSheets = ""
const wppLink = "https://wa.me/+5491171907681?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491171907681"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslNahuelIglesias;
