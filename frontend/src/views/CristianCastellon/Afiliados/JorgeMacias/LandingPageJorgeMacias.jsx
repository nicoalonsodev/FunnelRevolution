...
const LandingPageJorgeMacias = () => {

const url = "/jorge-macias/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbwPf5fcREZ9ZaxH-lGF42X23crRwo44VospEnPd1_kpzREeWLB0rKKixgO889ulEe5E/exec"
  return (
    <div >
      <div
...
export default LandingPageJorgeMacias;
