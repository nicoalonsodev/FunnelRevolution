...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/jorge-macias/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "jorge-macias"
const googleSheets = "https://script.google.com/macros/s/AKfycbwPf5fcREZ9ZaxH-lGF42X23crRwo44VospEnPd1_kpzREeWLB0rKKixgO889ulEe5E/exec"
const wppLink = "https://wa.me/+5492994135568?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5492994135568"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslJorgeMacias;
