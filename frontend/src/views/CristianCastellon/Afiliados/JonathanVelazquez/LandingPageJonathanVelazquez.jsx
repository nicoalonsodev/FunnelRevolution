...
const LandingPageJonathanVelazquez = () => {
 
const url = "/jonathan-velazquez/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbzjKMoca0k5msHzovQqibVWlXnjm9EFX1GZbb45OWOg5Gr-_FLoAHQAgQuo3h0teysGvA/exec"
  return (
    <div >
      <div
...
export default LandingPageJonathanVelazquez;
