...
const LandingPageRomanCo = () => {
 
const url = "/roman-correa/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbxCX906hSSZVdE0njyZa3aj93oCgXPEUYFiQYACQcrjUr8F6-dXG80aTqOliB1ffFdxYA/exec"
  return (
    <div >
      <div
...
export default LandingPageRomanCo;
