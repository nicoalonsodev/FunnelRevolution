...
const LandingPageKarinaKinta = () => {
 
const url = "/karina-quintana/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbyee5le6LLvGx1fFT4pv06dGR9XjPW4JxGPJXj_wCfw6UhMA_9HaLmCOb89ppxWcYmJDw/exec"
  return (
    <div >
      <div
...
export default LandingPageKarinaKinta;
