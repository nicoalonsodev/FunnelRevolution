...
const LandingPageSantiagoFerreiro = () => {
 
const url = "/santiago-ferreiro/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbz4QSJXWQPJLNdF-jSJ3GjWTpObXX_W4ixhiSRBytgeCPZIcv0umQIi6Gyf1zHOgluI/exec"
  return (
    <div >
      <div
...
export default LandingPageSantiagoFerreiro;
