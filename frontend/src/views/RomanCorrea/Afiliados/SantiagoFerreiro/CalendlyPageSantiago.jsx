...
const CalendlyPageSantiago = () => {
  ...
  const calendlyLink = "https://calendly.com/santiagoferreirotrader/llamada-de-inicio-revolution";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageSantiago;
