...
const historyPart3 = [
  ...
  const calendlyPage = "/santiago-ferreiro/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "santiago-ferreiro"
const googleSheets = "https://script.google.com/macros/s/AKfycbz4QSJXWQPJLNdF-jSJ3GjWTpObXX_W4ixhiSRBytgeCPZIcv0umQIi6Gyf1zHOgluI/exec"
const wppLink = "https://wa.me/+5493364005176?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5493364005176"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslSantiagoFer;
