...
const CalendlyPageFrancoNav = () => {
  ...
  const calendlyLink = "https://calendly.com/franco-trading93/llamada-de-iniciacion-en-revolution";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageFrancoNav;
