...
const historyPart3 = [
  ...
  const calendlyPage = "/franco-navarro/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "franco-navarro"
const googleSheets = "https://script.google.com/macros/s/AKfycbzyn2yAQiLd7JcEVqX2GBdxVRJEH2xP_OR_EXXxMaQTG6vQCdZ2CFvmDftO-_h_fYvldA/exec"
const wppLink = "https://wa.me/+5493400441831?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5493400441831"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslFrancoNav;
