...
const historyPart3 = [
  ...
  const calendlyPage = "/hernan-flores/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "hernan-flores"
const googleSheets = "https://script.google.com/macros/s/AKfycbymJAqA34ZUW9kkpX2Dxz_bRgXb1UfkwpPhEktHapWrm10-uYLPFffMjYmvQeloNFAi/exec"
const wppLink = "https://wa.me/+5493416662675?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5493416662675"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslHernanFlores;
