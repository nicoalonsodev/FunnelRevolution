...
const LandingPageHernanFlores = () => {
 
const url = "/hernan-flores/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbymJAqA34ZUW9kkpX2Dxz_bRgXb1UfkwpPhEktHapWrm10-uYLPFffMjYmvQeloNFAi/exec"
  return (
    <div >
      <div
...
export default LandingPageHernanFlores;
