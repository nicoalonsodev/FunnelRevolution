...
const CalendlyPageAlfonsoAgui = () => {
  ...
  const calendlyLink = "https://calendly.com/alfonsomaldonado2401/iniciacion-en-revolution";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageAlfonsoAgui;
