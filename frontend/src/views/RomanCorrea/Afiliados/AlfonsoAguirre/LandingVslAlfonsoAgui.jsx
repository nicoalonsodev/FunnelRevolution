...
const historyPart3 = [
  ...
  const calendlyPage = "/alfonso-aguirre/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "alfonso-aguirre"
const googleSheets = "https://script.google.com/macros/s/AKfycbwiYJZa8OUg0suOdNFMXeDfq2Y5fxVCJ5RGFxfrHL6c-EIyKMsUCGfgkE_tuDNG-kZj/exec"
const wppLink = "https://wa.me/+5491135141729?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491135141729"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
