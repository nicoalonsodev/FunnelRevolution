...
const LandingPageAlfonsoAgui = () => {
 
const url = "/alfonso-aguirre/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbwiYJZa8OUg0suOdNFMXeDfq2Y5fxVCJ5RGFxfrHL6c-EIyKMsUCGfgkE_tuDNG-kZj/exec"
  return (
    <div >
      <div
...
export default LandingPageAlfonsoAgui;
