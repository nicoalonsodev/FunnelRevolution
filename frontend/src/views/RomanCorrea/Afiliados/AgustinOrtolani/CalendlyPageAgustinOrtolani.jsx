...
const CalendlyPageAgustinOrtolani = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const calendlyLink = "https://calendly.com/agustinortolani6/ingreso-a-revolution";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageAgustinOrtolani;
