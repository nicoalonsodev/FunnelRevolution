...
const LandingVslAgustinOrtolani = () => {
...
const historyPart3 = [
  ...
  const calendlyPage = "/agustin-ortolani/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "agustin-ortolani"
const googleSheets = "https://script.google.com/macros/s/AKfycbxLAoyF6tD7kvri2CV2wYDJmCN7JSpVVWrtcMq_uogtXKG2WZ6QrAHA61lwB4taMTggrw/exec"
const wppLink = "https://wa.me/+5492344475041?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5492344475041"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslAgustinOrtolani;
