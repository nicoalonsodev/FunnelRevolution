...
const CalendlyPageMarianaRodriguez = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const calendlyLink = "https://calendly.com/marianaandrearodriguez1/llamada-de-iniciacion-revolution-4";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageMarianaRodriguez;
