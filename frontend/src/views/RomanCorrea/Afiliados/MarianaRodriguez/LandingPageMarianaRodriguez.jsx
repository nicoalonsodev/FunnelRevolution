...
const LandingPageMarianaRodriguez = () => {
 
const url = "/mariana-rodriguez/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbwa3lLl9yoOo_YKTzHQGfqGZJRVEEJh5M65gxTBzRPAA5WpesX0Jzlwv1bBDVf4vWIOTg/exec"
  return (
    <div >
      <div
...
export default LandingPageMarianaRodriguez;
