...
const CalendlyPageUrielBravo = () => {
  ...
  const calendlyLink = "https://calendly.com/urielpablobravo-19/llamada-de-iniciacion-de-revolution";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageUrielBravo;
