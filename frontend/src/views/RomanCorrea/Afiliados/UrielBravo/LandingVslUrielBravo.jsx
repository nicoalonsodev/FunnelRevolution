...
const historyPart3 = [
  ...
  const calendlyPage = "/uriel-bravo/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "uriel-bravo"
const googleSheets = "https://script.google.com/macros/s/AKfycbwp1TY8TK4n_RYcbdtZdjoFQ0JaIde_dU7vr3-WgIiGt6x4ph8FCfc79A2fy9nlQ-U1/exec"
const wppLink = "https://wa.me/+5493400419112?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5493400419112"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslUrielBravo;
