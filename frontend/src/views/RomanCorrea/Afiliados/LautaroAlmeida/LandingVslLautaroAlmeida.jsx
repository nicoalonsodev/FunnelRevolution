...
const LandingVslLautaroAlmeida = () => {
...
const historyPart3 = [
  ...
  const calendlyPage = "/lautaro-almeida/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "lautaro-almeida"
const googleSheets = "https://script.google.com/macros/s/AKfycbxkTF9t7Y9cD_KV6mPuYCtXDbr9_-fswjfh7TnyB3ae--ZdAxQtXU3p-EmrsvjPQfgUvg/exec"
const wppLink = "https://wa.me/+5493364333717?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5493364333717"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslLautaroAlmeida;
