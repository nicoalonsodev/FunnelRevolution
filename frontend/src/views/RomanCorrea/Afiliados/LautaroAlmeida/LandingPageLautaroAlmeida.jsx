...
const LandingPageLautaroAlmeida = () => {
 
const url = "/lautaro-almeida/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbxkTF9t7Y9cD_KV6mPuYCtXDbr9_-fswjfh7TnyB3ae--ZdAxQtXU3p-EmrsvjPQfgUvg/exec"
  return (
    <div >
      <div
...
export default LandingPageLautaroAlmeida;
