...
const CalendlyPageFabianGonzalez = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);

  const calendlyLink = "https://calendly.com/gonzalezivoleo/llamada-de-iniciacion-en-revolution-1";
  return (
...
export default CalendlyPageFabianGonzalez;
