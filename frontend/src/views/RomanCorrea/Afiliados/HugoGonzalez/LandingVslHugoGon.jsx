...
const historyPart3 = [
  ...
  const calendlyPage = "/hugo-gonzalez/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "hugo-gonzalez"
const googleSheets = "https://script.google.com/macros/s/AKfycbyEKm8hBOLqganQfzmVqRhThpldfltGyGsZ11i7znQmzsM2Ml18ivdLWuDZwdfbl1U3CQ/exec"
const wppLink = "https://wa.me/+5493415609441?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5493415609441"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslHugoGon;
