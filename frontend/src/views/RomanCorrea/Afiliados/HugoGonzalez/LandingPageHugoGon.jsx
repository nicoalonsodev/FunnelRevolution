...
const LandingPageHugoGon = () => {
 
const url = "/hugo-gonzalez/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbyEKm8hBOLqganQfzmVqRhThpldfltGyGsZ11i7znQmzsM2Ml18ivdLWuDZwdfbl1U3CQ/exec"
  return (
    <div >
      <div
...
export default LandingPageHugoGon;
