...
const CalendlyPageAgustinaGomez = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const calendlyLink = "https://calendly.com/riverplate04tina/tus-primeros-pasos-en-comunidad-revolution";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageAgustinaGomez
;