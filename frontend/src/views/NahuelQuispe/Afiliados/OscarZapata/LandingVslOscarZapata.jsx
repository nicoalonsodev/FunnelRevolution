...
const LandingVslOscarZapata = () => {
  ...
  const calendlyPage = "/oscar-zapata/calendly";
  const historyImages = [img1, img2, img3, img4];
  //const isRegistered = localStorage.getItem("isRegistered") === "true";
  const path = "oscar-zapata";
  const googleSheets = "https://script.google.com/macros/s/AKfycbxQX_GHau7TS8FCfv3kltgr-OKSvuWZxuEnAskLnUyyED-P7ULWvO9gC94V4NaX9zyR/exec"
const wppLink = "https://wa.me/+5491164022576?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491164022576"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslOscarZapata;
