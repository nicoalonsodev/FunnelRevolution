...
const LandingPageOscarZapata = () => {
 
const url = "/oscar-zapata/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbxQX_GHau7TS8FCfv3kltgr-OKSvuWZxuEnAskLnUyyED-P7ULWvO9gC94V4NaX9zyR/exec"
  return (
    <div >
      <div
...
export default LandingPageOscarZapata;
