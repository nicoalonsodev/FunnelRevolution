...
const LandingPageNahuelQuispe = () => {
 
const url = "/nahuel-quispe/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbySvYldbFeVPb3NFObSDAzoUH7pi5ccudbumyerNkzVs3pCKk6BBIUd4mPhjJo-oEtu/exec"
  return (
    <div >
      <div
...
export default LandingPageNahuelQuispe;
