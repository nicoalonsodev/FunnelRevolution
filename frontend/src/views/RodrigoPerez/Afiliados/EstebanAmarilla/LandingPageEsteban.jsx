...
const LandingPageEsteban = () => {
 
const url = "/esteban-amarilla/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbxfRM0XZJ2BKdozJXstDD1DMiXBfMyiTb0eZiOJIq_5dKr7WICnBRl8MClPMQxq_O_v/exec"
  return (
    <div >
      <div
...
export default LandingPageEsteban;
