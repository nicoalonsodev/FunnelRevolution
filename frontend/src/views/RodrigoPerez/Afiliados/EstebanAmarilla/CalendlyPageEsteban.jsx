...
const CalendlyPageEsteban = () => {
  ...
  const calendlyLink = "https://calendly.com/tebu-maka/llamada-de-iniciacion-revolution?month=2024-08";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageEsteban;
