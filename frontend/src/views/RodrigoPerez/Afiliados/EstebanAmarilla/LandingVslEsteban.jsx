...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/esteban-amarilla/calendly";
const historyImages = [ img1, img2, img3, img4]
    const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "esteban-amarilla"
const googleSheets = "https://script.google.com/macros/s/AKfycbxfRM0XZJ2BKdozJXstDD1DMiXBfMyiTb0eZiOJIq_5dKr7WICnBRl8MClPMQxq_O_v/exec"
const wppLink = "https://wa.me/+5491155855452?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491155855452"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslEsteban;
