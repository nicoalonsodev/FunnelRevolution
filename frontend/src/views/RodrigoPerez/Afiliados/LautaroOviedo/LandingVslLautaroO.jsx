...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/lautaro-oviedo/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "lautaro-oviedo"
const googleSheets = "https://script.google.com/macros/s/AKfycbyLuqpW0L0PJ3d6NSYf3e02V5N2nuGU4UYTZAiwH37En5mmi8sFTducZzUum78UX0hW/exec"
const wppLink = "https://wa.me/+5491153241602?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491153241602"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslLautaroO;
