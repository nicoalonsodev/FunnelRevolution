...
const LandingPageLautaroO = () => {
 
const url = "/lautaro-oviedo/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbyLuqpW0L0PJ3d6NSYf3e02V5N2nuGU4UYTZAiwH37En5mmi8sFTducZzUum78UX0hW/exec"
  return (
    <div >
      <div
...
export default LandingPageLautaroO;
