...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/ivan-silvero/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "ivan-silvero"
const googleSheets = "https://script.google.com/macros/s/AKfycbwJUrQzqfI8jSyk1vXTxRVl9WnFbReHvyXuAxfI4s7xoBAGekDcEXlQO_bDeMBMsyBbeg/exec"
const wppLink = "https://wa.me/+5491140768494?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491140768494"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
