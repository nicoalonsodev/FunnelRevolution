...
const LandingPageIvanS = () => {
 
const url = "/ivan-silvero/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbwJUrQzqfI8jSyk1vXTxRVl9WnFbReHvyXuAxfI4s7xoBAGekDcEXlQO_bDeMBMsyBbeg/exec"
  return (
    <div >
      <div
...
export default LandingPageIvanS;
