...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/franco-robles/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "franco-robles"
const googleSheets = "https://script.google.com/macros/s/AKfycbxo24E7y-vRNQErUrjT-tBn8vnGTDMlow8C5Lyc03tRGZvQ8yHkjthAF8818R_V8TrbrQ/exec"
const wppLink = "https://wa.me/+5491133983037?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491133983037"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslFrancoR;
