...
const LandingPageFrancoR = () => {
 
const url = "/franco-robles/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbxo24E7y-vRNQErUrjT-tBn8vnGTDMlow8C5Lyc03tRGZvQ8yHkjthAF8818R_V8TrbrQ/exec"
  return (
    <div >
      <div
...
export default LandingPageFrancoR;
