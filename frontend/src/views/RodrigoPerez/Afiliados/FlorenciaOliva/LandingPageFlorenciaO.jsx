...
const LandingPageFlorenciaO = () => {
 
const url = "/florencia-oliva/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbzGhopxaj-Kf4jzUCkKnoN3fRVU1-JDOOfzoXkPZoGc0Mdb4JXSHmC2mPiiEnkZ6_h8Nw/exec"
  return (
    <div >
      <div
...
export default LandingPageFlorenciaO;
