...
const CalendlyPageFlorenciaO = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);

  const calendlyLink = "https://calendly.com/valeria-florencia-oliva/llamada-de-iniciacion-revolution";
  return (
...
export default CalendlyPageFlorenciaO;
