...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/maximiliano-duarte/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "maximiliano-duarte"
const googleSheets = "https://script.google.com/macros/s/AKfycbzaWxGY7mHm1MLbkYV5SSSQ6IcD-BdyaPcq2ax6nZeRWm1VOhx9h72t083BZYEjfG5b/exec"
const wppLink = "https://wa.me/+5493795015723?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5493795015723"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
