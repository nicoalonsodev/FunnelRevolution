...
const CalendlyPageMaximilianoD = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const calendlyLink = "https://calendly.com/maisiduarte2119/llamada-de-iniciacion-revolution-2";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageMaximilianoD;
