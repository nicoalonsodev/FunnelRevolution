...
const LandingPageMaximilianoD = () => {
 
const url = "/maximiliano-duarte/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbzaWxGY7mHm1MLbkYV5SSSQ6IcD-BdyaPcq2ax6nZeRWm1VOhx9h72t083BZYEjfG5b/exec"
  return (
    <div >
      <div
...
export default LandingPageMaximilianoD;
