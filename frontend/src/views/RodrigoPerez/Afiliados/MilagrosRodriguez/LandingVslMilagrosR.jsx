...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/milagros-rodriguez/calendly";
const historyImages = [ img1, img2, img3, img4]
    const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "milagros-rodriguez"
const googleSheets = "https://script.google.com/macros/s/AKfycbycxoCBO1R95_AwQ6pgH5NcauCAakMEe4qArBSdsvlbFwn32PVWyo0F4sk1sYBPPMjJ/exec"
const wppLink = "https://wa.me/+5491133509727?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491133509727"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslMilagrosR;
