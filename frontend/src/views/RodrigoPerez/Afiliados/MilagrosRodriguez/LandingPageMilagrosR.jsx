...
const LandingPageMilagrosR = () => {
 
const url = "/milagros-rodriguez/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbycxoCBO1R95_AwQ6pgH5NcauCAakMEe4qArBSdsvlbFwn32PVWyo0F4sk1sYBPPMjJ/exec"
  return (
    <div >
      <div
...
export default LandingPageMilagrosR;
