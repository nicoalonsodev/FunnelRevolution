...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/maria-laura-gill/calendly";
const historyImages = [ img1, img2, img3, img4]
    const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "maria-laura-gill"
const googleSheets = "https://script.google.com/macros/s/AKfycbyCjA1j-LOOVUl8YolyNl93ZyA1HsfGZuUgunpI72PaAMFNU0WUp3cE_rN2zvywkEND/exec"
const wppLink = "https://wa.me/+5492616117847?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5492616117847"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
