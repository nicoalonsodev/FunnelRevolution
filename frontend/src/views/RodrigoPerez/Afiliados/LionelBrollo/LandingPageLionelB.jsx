...
const LandingPageLionelB = () => {
 
const url = "/lionel-brollo/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbzo6HxZ9CxPeBDy_Qk8gQ9bbkhn28MaJSc0ltbxIjNMFM0-EFPFCn446kLMD9g1O20KmQ/exec"
  return (
    <div >
      <div
...
export default LandingPageLionelB;
