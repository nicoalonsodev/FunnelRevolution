...
const LandingPageMatiasDechand = () => {
 
const url = "/matias-dechand/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycby6s7v8yfRJNQwFdCU6zRSih3Kh-hBH4th7zoyrLE8TtxUUsolPd0zv92we1FgN-ZB0ow/exec"
  return (
    <div >
      <div
...
export default LandingPageMatiasDechand;
