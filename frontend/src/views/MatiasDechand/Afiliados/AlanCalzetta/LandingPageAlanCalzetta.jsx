...
const LandingPageAlanCalzetta = () => {
 
const url = "/alan-calzetta/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbzEi_WJVD6vjRHBzeVoYC68KPec1vKa6A4u4wNzOL5Kjg7_EetDTwRXmC_eUEplb8A5/exec"
  return (
    <div >
      <div
...
export default LandingPageAlanCalzetta;
