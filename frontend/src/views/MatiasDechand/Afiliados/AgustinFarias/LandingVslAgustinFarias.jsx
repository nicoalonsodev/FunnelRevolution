...
const LandingVslAgustinFarias = () => {
  ...
  const path = "gonzalo-farias";
  const googleSheets = "https://script.google.com/macros/s/AKfycbxNHMfSIrTzzsLJYPSqE_LqJxhGj9mriVuIWUhSyv0r9tm4lR4VHSHPA5Fss6zYyJhPDQ/exec"
const wppLink = "https://wa.me/+5491127448020?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491127448020"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslAgustinFarias;
