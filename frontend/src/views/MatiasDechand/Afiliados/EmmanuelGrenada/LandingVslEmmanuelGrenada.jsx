...
const LandingVslEmmanuelGrenada = () => {
  ...
  const calendlyPage = "/emmanuel-grenada/calendly";
  const historyImages = [img1, img2, img3, img4];
  const isRegistered = localStorage.getItem("isRegistered") === "true";
  const path = "emmanuel-grenada";
  const googleSheets = "https://script.google.com/macros/s/AKfycbwXSHOpjpxUM0VMLfLbzk8tYrP2ooxNQ2OsSS2wmzjDBRK9Ly_jjLz8vc_VbcUvqsxecQ/exec"
const wppLink = "https://wa.me/+5492923648320?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5492923648320"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslEmmanuelGrenada;
