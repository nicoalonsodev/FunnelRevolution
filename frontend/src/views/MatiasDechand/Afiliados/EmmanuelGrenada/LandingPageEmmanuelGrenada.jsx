...
const LandingPageEmmanuelGrenada = () => {
 
const url = "/emmanuel-grenada/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbwXSHOpjpxUM0VMLfLbzk8tYrP2ooxNQ2OsSS2wmzjDBRK9Ly_jjLz8vc_VbcUvqsxecQ/exec"
  return (
    <div >
      <div
...
export default LandingPageEmmanuelGrenada;
