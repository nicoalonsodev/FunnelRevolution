...
const LandingPageGuillermoTognola = () => {
 
const url = "/guillermo-tognola/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbz0yOhoFOFARupJnQN2Z0ge9IbGKeBRHcyBNRf2ck7j71UYFbybu_oNdPapCnFRVUQp/exec"
  return (
    <div >
      <div
...
export default LandingPageGuillermoTognola;
