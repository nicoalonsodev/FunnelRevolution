...
const CalendlyPageGuillermoTognola = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const calendlyLink = "https://calendly.com/gtognolainversiones/reunion-de-iniciacion-revo";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageGuillermoTognola
;