...
const LandingVslAgustinRodriguez = () => {
  ...
  const calendlyPage = "/agustin-rodriguez/calendly";
  const historyImages = [img1, img2, img3, img4];
  //const isRegistered = localStorage.getItem("isRegistered") === "true";
  const path = "agustin-rodriguez";
  const googleSheets = "https://script.google.com/macros/s/AKfycbwSnaLpRPhmYdv2vR8KuR6hcl0WT5mm1SBQ2h0ElTqERVWhbps8RZ01_oCibxVQPGLR/exec"
const wppLink = "https://wa.me/+5491165849608?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491165849608"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslAgustinRodriguez;
