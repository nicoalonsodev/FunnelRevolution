...
const CalendlyPageAgustinRodriguez = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const calendlyLink = "https://calendly.com/agustin-rod/llamada-de-iniciacion-en-revolution";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageAgustinRodriguez;
