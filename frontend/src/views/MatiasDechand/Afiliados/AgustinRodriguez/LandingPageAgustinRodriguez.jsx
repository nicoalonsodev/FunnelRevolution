...
const LandingPageAgustinRodriguez = () => {
 
const url = "/agustin-rodriguez/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbwSnaLpRPhmYdv2vR8KuR6hcl0WT5mm1SBQ2h0ElTqERVWhbps8RZ01_oCibxVQPGLR/exec"
  return (
    <div >
      <div
...
export default LandingPageAgustinRodriguez;
