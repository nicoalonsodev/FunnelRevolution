...
const LandingVslMatiasDoCuoto = () => {
  ...
  const calendlyPage = "/matias-do-cuoto/calendly";
  const historyImages = [img1, img2, img3, img4];
  //const isRegistered = localStorage.getItem("isRegistered") === "true";
  const path = "matias-do-cuoto";
  const googleSheets = "https://script.google.com/macros/s/AKfycbyB7YvkxdlTxyP5Wo8b0id3bbe4hmQIt6sM2QvyBgwJDd1Mav19zDaA4lrxsM0up11uvw/exec"
const wppLink = "https://wa.me/+5491157487180?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491157487180"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslMatiasDoCuoto;
