...
const LandingPageMatiasDoCuoto = () => {
 
const url = "/matias-do-cuoto/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbyB7YvkxdlTxyP5Wo8b0id3bbe4hmQIt6sM2QvyBgwJDd1Mav19zDaA4lrxsM0up11uvw/exec"
  return (
    <div >
      <div
...
export default LandingPageMatiasDoCuoto;
