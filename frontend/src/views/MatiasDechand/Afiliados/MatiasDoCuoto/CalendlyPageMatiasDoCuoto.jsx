...
const CalendlyPageMatiasDoCuoto = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const calendlyLink = "https://calendly.com/docoutobriosomatias/llamada-de-iniciacion-revolution";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageMatiasDoCuoto
;