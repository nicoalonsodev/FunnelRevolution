...
const LandingVslAlanFerreira = () => {
  ...
  const calendlyPage = "/alan-ferreira/calendly";
  const historyImages = [img1, img2, img3, img4];
  //const isRegistered = localStorage.getItem("isRegistered") === "true";
  const path = "alan-ferreira";
  const googleSheets = "https://script.google.com/macros/s/AKfycbwX_o6j5nVBwbNfOSAQURf47hcTPWcev02xGsOV-BxsJlRkoOC4TLUcLXXhI7nhdYu5/exec"
const wppLink = "https://wa.me/+5491133460779?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491133460779"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslAlanFerreira;
