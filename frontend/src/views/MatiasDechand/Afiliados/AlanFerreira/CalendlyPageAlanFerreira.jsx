...
const CalendlyPageAlanFerreira = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const calendlyLink = "https://calendly.com/alanferreiran/llamada-de-iniciacion-en-revolution";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageAlanFerreira
;