...
const LandingPageIgnacioCostantini = () => {
 
const url = "/ignacio-costantini/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbz8VBPJw3GJtor77jTkBhdPpvU3JRwEVk8a_6ZVhFCT_BEO01wH-dxlpZyBCgjDzbmY/exec"
  return (
    <div >
      <div
...
export default LandingPageIgnacioCostantini;
