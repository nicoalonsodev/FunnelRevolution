...
const LandingVslIgnacioCostantini = () => {
  ...
  const calendlyPage = "/ignacio-costantini/calendly";
  const historyImages = [img1, img2, img3, img4];
  //const isRegistered = localStorage.getItem("isRegistered") === "true";
  const path = "ignacio-costantini";
  const googleSheets = "https://script.google.com/macros/s/AKfycbz8VBPJw3GJtor77jTkBhdPpvU3JRwEVk8a_6ZVhFCT_BEO01wH-dxlpZyBCgjDzbmY/exec"
const wppLink = "https://wa.me/+5491140728627?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491140728627"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslIgnacioCostantini;
