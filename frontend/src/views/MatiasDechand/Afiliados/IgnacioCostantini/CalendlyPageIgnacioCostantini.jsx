...
const CalendlyPageIgnacioCostantini = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const calendlyLink = "https://calendly.com/nachocostantini/llamada-de-iniciacion-de-revolution";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageIgnacioCostantini
;