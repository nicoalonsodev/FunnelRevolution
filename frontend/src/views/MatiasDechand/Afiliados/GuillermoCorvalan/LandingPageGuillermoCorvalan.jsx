...
const LandingPageGuillermoCorvalan = () => {
 
const url = "/guillermo-corvalan/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbxPaWWJFSYQeefcdAmGew8oj1IEOHV3LLZDXCHyJzm2ISobmvSyepbP4GoDV5rSnTsDKg/exec"
  return (
    <div >
      <div
...
export default LandingPageGuillermoCorvalan;
