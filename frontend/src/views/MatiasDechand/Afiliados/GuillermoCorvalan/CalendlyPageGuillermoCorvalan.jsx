...
const CalendlyPageGuillermoCorvalan = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const calendlyLink = "https://calendly.com/challengerlasgg/llamada-de-iniciacion-revolution";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageGuillermoCorvalan
;