...
const actually = [
 ...
 `Aquí te presento "los tres pilares" de este modelo de negocio que transformará tu vida...`,
  ...
  const calendlyPage = "/ulises-coronel/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "ulises-coronel"
const googleSheets = "https://script.google.com/macros/s/AKfycbzd7SEm2OgJ7QQTCr-2VHLC131I7TD9lpYrrQGpXsEyCER3IpsMEuxL85d3Y4y1Sc79/exec"
const wppLink = "https://wa.me/+5492345427570?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5492345427570"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
