...
const actually = [
 ...
 `Aquí te presento "los tres pilares" de este modelo de negocio que transformará tu vida...`,
  ...
  const calendlyPage = "/jeronimo-gallasso/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "jeronimo-gallasso"
const googleSheets = "https://script.google.com/macros/s/AKfycbxhYSEJE4o-Rs5mZj6KDaqGwdjzZRdCDTOiOIAauUl72mPBOmwyo2LLspy0akLPa2UJOg/exec"
const wppLink = "https://wa.me/+5492212667506?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5492212667506"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslJeronimo;
