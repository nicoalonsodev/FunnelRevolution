...
const LandingPageJeronimo = () => {
 
const url = "/jeronimo-gallasso/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbxhYSEJE4o-Rs5mZj6KDaqGwdjzZRdCDTOiOIAauUl72mPBOmwyo2LLspy0akLPa2UJOg/exec"
  return (
    <div >
      <div
...
export default LandingPageJeronimo;
