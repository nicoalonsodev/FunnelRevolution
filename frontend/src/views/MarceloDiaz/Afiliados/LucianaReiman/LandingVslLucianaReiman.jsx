...
const actually = [
 ...
 `Aquí te presento "los tres pilares" de este modelo de negocio que transformará tu vida...`,
  ...
  const calendlyPage = "/luciana-reiman/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "luciana-reiman"
const googleSheets = "https://script.google.com/macros/s/AKfycbxg0iStrecdQxF3fcysIBBgOcJ3HFX9C4XVz6WmS6h4misBJf-tIVjFlS5Aju4jF-5ALw/exec"
const wppLink = "https://wa.me/+5491171706725?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491171706725"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
