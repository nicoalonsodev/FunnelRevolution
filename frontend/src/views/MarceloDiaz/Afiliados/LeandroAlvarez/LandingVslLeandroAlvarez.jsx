...
const LandingVslLeandroAlvarez = () => {
...
const actually = [
 ...
 `Aquí te presento "los tres pilares" de este modelo de negocio que transformará tu vida...`,
  ...
  const calendlyPage = "/leandro-alvarez/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "leandro-alvarez"
const googleSheets = "https://script.google.com/macros/s/AKfycbyLHFunPQOQT_obZZwAxqKCtPDa0qhCEoD6ImNqZ6yONDlIhkwwKG97P8hhhxEmvx-9Nw/exec"
const wppLink = "https://wa.me/+5491166756485?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491166756485"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslLeandroAlvarez;
