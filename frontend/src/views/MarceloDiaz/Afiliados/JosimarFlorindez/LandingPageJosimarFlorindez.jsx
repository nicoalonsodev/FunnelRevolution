...
const LandingPageJosimarFlorindez = () => {
 
const url = "/josimar-florindez/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbwQOqqNZWTYrWDaohiHUo2QBcd_7UD7gDtEhMQeTtgH4ZkX3EQ0E_k_-ucge8hmL-Ob/exec"
  return (
    <div >
      <div
...
export default LandingPageJosimarFlorindez;
