...
const LandingVslJosimarFlorindez = () => {
...
const actually = [
 ...
 `Aquí te presento "los tres pilares" de este modelo de negocio que transformará tu vida...`,
  ...
  const calendlyPage = "/josimar-florindez/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "josimar-florindez"
const googleSheets = "https://script.google.com/macros/s/AKfycbwQOqqNZWTYrWDaohiHUo2QBcd_7UD7gDtEhMQeTtgH4ZkX3EQ0E_k_-ucge8hmL-Ob/exec"
const wppLink = "https://wa.me/+51914227276?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+51914227276"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslJosimarFlorindez;
