...
const CalendlyPageJosimarFlorindez = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  // El Link de Calendly
  const calendlyLink = "https://calendly.com/jossimarflorindez/llamada-de-iniciacion-de-revolution";
...
export default CalendlyPageJosimarFlorindez;
