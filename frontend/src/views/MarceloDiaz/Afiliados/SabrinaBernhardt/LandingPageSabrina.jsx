...
const LandingPageSabrina = () => {
 
const url = "/sabrina-bernhardt/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbzMQz4KrGwHTo6KT7gdPKDQycpDpAHnB36JZMb7diqHdZUv0WECnvzAEdsO3jOKDC6x/exec"
  return (
    <div >
      <div
...
export default LandingPageSabrina;
