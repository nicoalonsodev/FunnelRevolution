...
const actually = [
 ...
 `Aquí te presento "los tres pilares" de este modelo de negocio que transformará tu vida...`,
  ...
  const calendlyPage = "/sabrina-bernhardt/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "sabrina-bernhardt"
const googleSheets = "https://script.google.com/macros/s/AKfycbzMQz4KrGwHTo6KT7gdPKDQycpDpAHnB36JZMb7diqHdZUv0WECnvzAEdsO3jOKDC6x/exec"
const wppLink = "https://wa.me/+573045317572?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+573045317572"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslSabrina;
