...
const actually = [
 ...
 `Aquí te presento "los tres pilares" de este modelo de negocio que transformará tu vida...`,
  ...
  const calendlyPage = "/diego-vargas/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "diego-vargas"
const googleSheets = "https://script.google.com/macros/s/AKfycbz6KFCLHlIivZY59FZpv0HEDUcquhluCHFEiYuhZIsfnVk6Y6Ce1C87HOrtPeliQ9w0fg/exec"
const wppLink = "https://wa.me/+5492214942922?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5492214942922"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslDiegoV;
