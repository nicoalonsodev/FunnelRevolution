...
const LandingPageDiegoV = () => {
 
const url = "/diego-vargas/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbz6KFCLHlIivZY59FZpv0HEDUcquhluCHFEiYuhZIsfnVk6Y6Ce1C87HOrtPeliQ9w0fg/exec"
  return (
    <div >
      <div
...
export default LandingPageDiegoV;
