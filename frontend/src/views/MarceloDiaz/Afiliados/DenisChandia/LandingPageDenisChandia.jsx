...
const LandingPageDenisChandia = () => {
 
const url = "/denis-chandia/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycby3nWyACDK3WXQ470zFv03-UJSmIcJQCAdhkoTDRktZKY_f04S9r1mqDiZaNDTlzVKNrQ/exec"
  return (
    <div >
      <div
...
export default LandingPageDenisChandia;
