...
const actually = [
 ...
 `Aquí te presento "los tres pilares" de este modelo de negocio que transformará tu vida...`,
  ...
  const calendlyPage = "/denis-chandia/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "denis-chandia"
const googleSheets = "https://script.google.com/macros/s/AKfycby3nWyACDK3WXQ470zFv03-UJSmIcJQCAdhkoTDRktZKY_f04S9r1mqDiZaNDTlzVKNrQ/exec"
const wppLink = "https://wa.me/+5491151113238?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491151113238"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslDenisChandia;
