...
const actually = [
 ...
 `Aquí te presento "los tres pilares" de este modelo de negocio que transformará tu vida...`,
  ...
  const calendlyPage = "/carla-hornos/calendly";
const historyImages = [ img1, img2, img3, img4]
    const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "carla-hornos"
const googleSheets = "https://script.google.com/macros/s/AKfycbz2zWw12dnd95xBsV1qcys-IXCcAK-Gax43nTYsmdA0JVw6AcQVfIoicbjnU_X-DNqi/exec"
const wppLink = "https://wa.me/+5492944819349?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5492944819349"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslCarlaHornos;
