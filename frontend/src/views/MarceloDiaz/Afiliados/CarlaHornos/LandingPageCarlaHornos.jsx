...
const LandingPageCarlaHornos = () => {
 
const url = "/carla-hornos/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbz2zWw12dnd95xBsV1qcys-IXCcAK-Gax43nTYsmdA0JVw6AcQVfIoicbjnU_X-DNqi/exec"
  return (
    <div >
      <div
...
export default LandingPageCarlaHornos;
