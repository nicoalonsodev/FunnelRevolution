...
const LandingPageLucasRuiz = () => {
 
const url = "/lucas-ruiz/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbyC1LIaaNc34CKVHahuSQCJu2JD1wI1kc1Y6jBavizfa1fgJGjcm_8Hy_bykUYRi1Cf/exec"
  return (
    <div >
      <div
...
export default LandingPageLucasRuiz;
