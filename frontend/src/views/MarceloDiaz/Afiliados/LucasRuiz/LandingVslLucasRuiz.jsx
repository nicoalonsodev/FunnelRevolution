...
const actually = [
 ...
 `Aquí te presento "los tres pilares" de este modelo de negocio que transformará tu vida...`,
  ...
  const calendlyPage = "/lucas-ruiz/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "lucas-ruiz"
const googleSheets = "https://script.google.com/macros/s/AKfycbyC1LIaaNc34CKVHahuSQCJu2JD1wI1kc1Y6jBavizfa1fgJGjcm_8Hy_bykUYRi1Cf/exec"
const wppLink = "https://wa.me/+5493857512760?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5493857512760"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslLucasRuiz;
