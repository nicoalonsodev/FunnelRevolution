...
const CalendlyPageLucasRuiz = () => {
  ...
  // El Link de Calendly
  const calendlyLink = "https://calendly.com/ruizmansillalucasfacundo/llamada-de-iniciacion-revolution";
...
export default CalendlyPageLucasRuiz;
