...
const LandingPageMauricioVarela = () => {
 
const url = "/mauricio-varela/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbyovYEsBMZSOyEfLdUmzNXUI5Nz84NLIZ4S1RxQi8mCroerJK1CiFi5wdKKwAfnXEZ5VQ/exec"
  return (
    <div >
      <div
...
export default LandingPageMauricioVarela;
