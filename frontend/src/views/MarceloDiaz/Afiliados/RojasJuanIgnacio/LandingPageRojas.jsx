...
const LandingPageRojas = () => {
 
const url = "/rojas-juan/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbyf5b057st2kaZsg6oVoz7EM6e7DYc2Cex-veX-482wVVZKeTSfzWzKiBQouQ6eDu42/exec"
  return (
    <div >
      <div
...
export default LandingPageRojas;
