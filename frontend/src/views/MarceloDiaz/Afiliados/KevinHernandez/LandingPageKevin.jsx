...
const LandingPageKevin = () => {
 
const url = "/kevin-hernandez/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbwRrP6XT8imnxGcHC2EY5eW7kVTEXlu5CZFRxE7fuypqaEF_WtFF91HP_dwzzDfiwQ51Q/exec"
  return (
    <div >
      <div
...
export default LandingPageKevin;
