...
const CalendlyPageKevin = () => {
  ...
  // El Link de Calendly
  const calendlyLink = "https://calendly.com/kromindofficial/llamada-para-iniciar-en-revolution?month=2024-08";
...
export default CalendlyPageKevin;
