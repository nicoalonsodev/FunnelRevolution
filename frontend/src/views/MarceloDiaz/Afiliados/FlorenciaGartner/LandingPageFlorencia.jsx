...
const LandingPageFlorencia = () => {
 
const url = "/florencia-gartner/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbwz6o2YGVUstnSOPFU_XMQ5WNp2-zOZXOW002KSqrLflkHC9Uj7n6grqYIgdcHQHLVB/exec"
  return (
    <div >
      <div
...
export default LandingPageFlorencia;
