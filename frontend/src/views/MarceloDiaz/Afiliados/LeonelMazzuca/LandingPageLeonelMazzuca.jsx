...
const LandingPageLeonelMazzuca = () => {
 
const url = "/leonel-mazzuca/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbwzu5ieX46DQ2OekqMJjQTSyi4xJypLWTQvBRDOIfc7xvkq7SagYwCbsT1f21e56kiMnA/exec"
  return (
    <div >
      <div
...
export default LandingPageLeonelMazzuca;
