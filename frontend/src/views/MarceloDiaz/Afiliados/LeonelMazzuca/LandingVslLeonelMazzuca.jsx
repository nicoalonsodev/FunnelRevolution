...
const actually = [
 ...
 `Aquí te presento "los tres pilares" de este modelo de negocio que transformará tu vida...`,
  ...
  const calendlyPage = "/leonel-mazzuca/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "leonel-mazzuca"
const googleSheets = "https://script.google.com/macros/s/AKfycbwzu5ieX46DQ2OekqMJjQTSyi4xJypLWTQvBRDOIfc7xvkq7SagYwCbsT1f21e56kiMnA/exec"
const wppLink = "https://wa.me/+5492215412069?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5492215412069"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslLeonelMazzuca;
