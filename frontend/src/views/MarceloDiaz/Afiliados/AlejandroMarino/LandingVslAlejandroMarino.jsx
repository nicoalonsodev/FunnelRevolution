...
const LandingVslAlejandroMarino = () => {
...
const actually = [
 ...
 `Aquí te presento "los tres pilares" de este modelo de negocio que transformará tu vida...`,
  ...
  const calendlyPage = "/alejandro-marino/calendly";
const historyImages = [ img1, img2, img3, img4]
    const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "alejandro-marino"
const googleSheets = "https://script.google.com/macros/s/AKfycbzm7YNwD8aRIx3Odh38j54c9IuaaeWzssAEbg08kKptVZ941S_Thlu7S4IhXgO8qSDf0Q/exec"
...
export default LandingVslAlejandroMarino;
