...
const LandingPageMarcelo = () => {
 
const url = "/marcelo-diaz/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbxNzmiQhbrG8LHeiOlEAkQHMLZ2a6_zN235T2-vZYaQIGVM8HwNIerr0rtnLV1RlaQ0Iw/exec"
  return (
    <div >
      <div
...
export default LandingPageMarcelo;
