...
const LandingPageWalterFreire = () => {
 
const url = "/walter-freire/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbwYB7MMxzEv6hRUV1-Puvni1qeqWrTnJH06MrvxY-5zp6UWDpx70OTN-6Inh-2EZgycKw/exec"
  return (
    <div >
      <div
...
export default LandingPageWalterFreire;
