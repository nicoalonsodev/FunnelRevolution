...
const LandingPageMiguelLavigna = () => {
 
const url = "/miguel-lavigna/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbyZLJWfSHMs28Y2Rwyo9HUq4fBy7yvtUf5NvyT2AnWuq08x9Uhr7o4aaCjpPnPn2LO-cg/exec"
  return (
    <div >
      <div
...
export default LandingPageMiguelLavigna;
