...
const CalendlyPageMiguelLavigna = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);

  const calendlyLink = "https://calendly.com/lavignamiguel278/llamada-de-iniciacion-revolution";
  return (
...
export default CalendlyPageMiguelLavigna;
