...
const actually = [
  ...
  const calendlyPage = "/mariano-soria/calendly";
const historyImages = [ img1, img2, img3, img4]
    const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "mariano-soria"
const googleSheets = "https://script.google.com/macros/s/AKfycbxDufd4r2gcfUOlqPfKj3fgG-l_zD6PGfnWpXpjWRNTc7dAm0zo-AGho_-Xc3CabP-v/exec"
const wppLink = "https://wa.me/+5493446594474?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5493446594474"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslMarianoSoria;
