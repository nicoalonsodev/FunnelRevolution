...
const CalendlyPageMarianoSoria = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const calendlyLink = "https://calendly.com/marianosoria91/llamada-de-iniciacion-en-revolution";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageMarianoSoria;
