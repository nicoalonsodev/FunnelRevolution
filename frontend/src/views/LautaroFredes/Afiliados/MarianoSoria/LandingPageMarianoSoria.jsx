...
const LandingPageMarianoSoria = () => {
 
const url = "/mariano-soria/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbxDufd4r2gcfUOlqPfKj3fgG-l_zD6PGfnWpXpjWRNTc7dAm0zo-AGho_-Xc3CabP-v/exec"
  return (
    <div >
      <div
...
export default LandingPageMarianoSoria;
