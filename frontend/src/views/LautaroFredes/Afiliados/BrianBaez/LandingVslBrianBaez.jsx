...
const actually = [
  ...
  const calendlyPage = "/brian-baez/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "brian-baez"
const googleSheets = "https://script.google.com/macros/s/AKfycbyS-8GF2EJzsiSYQWfEVgrXiA44lwIn0qb6VWl5Hb9fVL5heMQYNx4AohvRWa4t9WJPMQ/exec"
const wppLink = "https://wa.me/+5491166379245?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491166379245"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslBrianBaez;
