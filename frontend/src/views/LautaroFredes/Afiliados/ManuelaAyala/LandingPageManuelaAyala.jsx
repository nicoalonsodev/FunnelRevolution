...
const LandingPageManuelaAyala = () => {
 
const url = "/manuela-ayala/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbx-xOaB5aCfGfv35uWxSxWb7AqZ50QlmJYha9pAfi4fZ3HLXnRwK4P_C5h_0hqL7HU/exec"
  return (
    <div >
      <div
...
export default LandingPageManuelaAyala;
