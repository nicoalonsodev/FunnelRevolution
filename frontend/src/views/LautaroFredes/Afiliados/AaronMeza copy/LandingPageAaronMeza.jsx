...
const LandingPageAaronMeza = () => {
 
const url = "/aaron-meza/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbwHN3Mf5InWJn5tzfnehg-MFzx46UZgc_d7hEMuJSkKCzbF6f7q5SrePIXXK45KlHon/exec"
  return (
    <div >
      <div
...
export default LandingPageAaronMeza;
