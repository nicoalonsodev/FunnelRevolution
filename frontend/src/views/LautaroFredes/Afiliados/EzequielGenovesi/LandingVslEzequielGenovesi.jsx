...
const actually = [
  ...
  const calendlyPage = "/ezequiel-genovesi/calendly";
const historyImages = [ img1, img2, img3, img4]
    const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "ezequiel-genovesi"
const googleSheets = "https://script.google.com/macros/s/AKfycbyblo3Susmc1fZ0q6zwVYk8OLzI6Oqcc9OBQufz7QbGxFwQ30BxleFLxjjcUdwXKKXt/exec"
const wppLink = "https://wa.me/+5491126870998?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491126870998"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslEzequielGenovesi;
