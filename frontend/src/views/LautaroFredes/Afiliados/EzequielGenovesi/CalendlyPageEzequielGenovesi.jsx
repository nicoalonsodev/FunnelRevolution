...
const CalendlyPageEzequielGenovesi = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const calendlyLink = "https://calendly.com/genovesiezequiel/asesoria-revolution";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageEzequielGenovesi;
