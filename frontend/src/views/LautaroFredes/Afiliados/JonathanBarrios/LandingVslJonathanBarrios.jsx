...
const LandingVslJonathanBarrios = () => {
...
const actually = [
  ...
  const calendlyPage = "/jonathan-barrios/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "jonathan-barrios"
const googleSheets = "https://script.google.com/macros/s/AKfycbzoE8M1Dcg6_bIGvjZtahQgwpnyMsLdHfZ0j1XsajJNqSvb37rHwmI9RhNrlDjM1Jhx8w/exec"
const wppLink = "https://wa.me/+5491157184271?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491157184271"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslJonathanBarrios;
