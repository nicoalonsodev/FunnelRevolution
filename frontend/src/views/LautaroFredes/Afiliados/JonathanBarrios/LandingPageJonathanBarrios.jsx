...
const LandingPageJonathanBarrios = () => {
 
const url = "/jonathan-barrios/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbzoE8M1Dcg6_bIGvjZtahQgwpnyMsLdHfZ0j1XsajJNqSvb37rHwmI9RhNrlDjM1Jhx8w/exec"
  return (
    <div >
      <div
...
export default LandingPageJonathanBarrios;
