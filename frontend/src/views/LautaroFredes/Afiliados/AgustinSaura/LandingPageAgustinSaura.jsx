...
const LandingPageAgustinSaura = () => {
 
const url = "/agustin-saura/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbxdt7iUNsJJA3Gca7uGZh7NTxc9mFMcpsmjzbyBDkEnQcPX-3CaT6NDb-uOSAAwMCjl/exec"
  return (
    <div >
      <div
...
export default LandingPageAgustinSaura;
