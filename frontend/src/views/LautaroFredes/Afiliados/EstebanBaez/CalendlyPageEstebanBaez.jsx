...
const CalendlyPageEstebanBaez = () => {
  ...
  const calendlyLink = "https://calendly.com/cocuera2017/llamada-de-como-iniciar-en-revolution";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageEstebanBaez;
