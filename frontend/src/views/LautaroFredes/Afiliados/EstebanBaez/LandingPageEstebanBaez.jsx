...
const LandingPageEstebanBaez = () => {
 
const url = "/esteban-baez/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbwTjKe34Ay230_ldKQzBKm0xTKNMdZMiwNbnhBpJt_xbghALfDaBuk5OpLsq9fp8wEPUA/exec"
  return (
    <div >
      <div
...
export default LandingPageEstebanBaez;
