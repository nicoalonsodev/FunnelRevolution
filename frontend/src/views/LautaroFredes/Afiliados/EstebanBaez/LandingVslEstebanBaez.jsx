...
const actually = [
  ...
  const calendlyPage = "/esteban-baez/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "esteban-baez"
const googleSheets = "https://script.google.com/macros/s/AKfycbwTjKe34Ay230_ldKQzBKm0xTKNMdZMiwNbnhBpJt_xbghALfDaBuk5OpLsq9fp8wEPUA/exec"
const wppLink = "https://wa.me/+5491168851651?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491168851651"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslEstebanBaez;
