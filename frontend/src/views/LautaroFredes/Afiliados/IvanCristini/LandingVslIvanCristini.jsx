...
const actually = [
  ...
  const calendlyPage = "/ivan-cristini/calendly";
const historyImages = [ img1, img2, img3, img4]
    const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "ivan-cristini"
const googleSheets = "https://script.google.com/macros/s/AKfycbxZ1Kmbkvfgkth8dSsIKYD1A7E1-xD1c_4qYRX9QyTHFj9llq9DMBhH74DcvIhnxKjkyA/exec"
const wppLink = "https://wa.me/+5491165631594?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491165631594"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslIvanCristini;
