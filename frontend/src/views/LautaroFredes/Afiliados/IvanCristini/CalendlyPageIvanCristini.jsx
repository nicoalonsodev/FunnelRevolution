...
const CalendlyPageIvanCristini = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const calendlyLink = "https://calendly.com/ivancristini2024/30min?back=1&month=2024-08";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageIvanCristini;
