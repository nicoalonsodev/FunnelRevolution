...
const LandingPageIvanCristini = () => {
 
const url = "/ivan-cristini/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbxZ1Kmbkvfgkth8dSsIKYD1A7E1-xD1c_4qYRX9QyTHFj9llq9DMBhH74DcvIhnxKjkyA/exec"
  return (
    <div >
      <div
...
export default LandingPageIvanCristini;
