...
const CalendlyPageDiegoMassaccesi = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const calendlyLink = "https://calendly.com/diegomassaccesi83/llamada-de-iniciacion-revolution";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageDiegoMassaccesi
;