...
const LandingPageMatiasVera = () => {
 
const url = "/matias-vera/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbxK2OXgIzshCAI0LH9BXDjf4lppxyqttT8TGv16jO9YGx1aW-SAVGbG2v_dCB6O0VwD/exec"
  return (
    <div >
      <div
...
export default LandingPageMatiasVera;
