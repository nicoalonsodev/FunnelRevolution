...
const CalendlyPageMatiasVera = () => {
  ...
  const calendlyLink = "https://calendly.com/verainfantematias/llamada-de-introduccion-a-revolution";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageMatiasVera
;