...
const LandingPageGenaroDadamo = () => {
 
const url = "/genaro-dadamo/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbx0q8hf4rV6JAfPhemDZzcKKRyMHcudIXaHPcYNRGuWGoOTDD1q7cb3g7NZlK_OyPDvcA/exec"
  return (
    <div >
      <div
...
export default LandingPageGenaroDadamo;
