...
const LandingVslGenaroDadamo = () => {
  ...
  const calendlyPage = "/genaro-dadamo/calendly";
  const historyImages = [img1, img2, img3, img4];
  const isRegistered = localStorage.getItem("isRegistered") === "true";
  const path = "genaro-dadamo";
  const googleSheets = "https://script.google.com/macros/s/AKfycbx0q8hf4rV6JAfPhemDZzcKKRyMHcudIXaHPcYNRGuWGoOTDD1q7cb3g7NZlK_OyPDvcA/exec"
const wppLink = "https://wa.me/+5492932611203?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5492932611203"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslGenaroDadamo;
