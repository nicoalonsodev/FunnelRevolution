...
const LandingPageRomina = () => {
 
const url = "/romina-luppi/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycby_uqylm8NA9Voyks0pLkoEncVQrQn3iohMr84FNAgWm0MiOdHe_JyfugsiJHjsSrAlcg/exec"
  return (
    <div >
      <div
...
export default LandingPageRomina;
