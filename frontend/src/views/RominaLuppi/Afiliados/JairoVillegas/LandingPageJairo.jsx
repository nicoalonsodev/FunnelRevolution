...
const LandingPageJairo = () => {
 
  const url = "/jairo-villegas/vsl?registered=true";
  const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbwd8PNhIFifJBbYH9MsKGs-vermmhAfkSijrfmjCpfeKP7QCxoYhmpAMTvHbZHzRaiU/exec"
    return (
      <div >
        <div
  ...
  export default LandingPageJairo;
