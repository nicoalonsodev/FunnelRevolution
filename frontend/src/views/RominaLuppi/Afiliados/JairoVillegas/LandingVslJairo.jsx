...
const actually = [
 ...
 `Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/jairo-villegas/calendly";
const historyImages = [ img1, img2, img3, img4]
    const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "jairo-villegas"
const googleSheets = "https://script.google.com/macros/s/AKfycbwd8PNhIFifJBbYH9MsKGs-vermmhAfkSijrfmjCpfeKP7QCxoYhmpAMTvHbZHzRaiU/exec"
const wppLink = "https://wa.me/+5491124950506?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491124950506"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslJairo;
