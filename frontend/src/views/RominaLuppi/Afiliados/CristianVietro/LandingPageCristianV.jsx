...
const LandingPageCristianV = () => {
 
  const url = "/cristian-vietro/vsl?registered=true";
  const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbzhZ-BR7anX06CaccQefcpERuSqTAsyK7qxVFGiNYm2rjgPuC-UEYzkO-ZQu6otCqqPPQ/exec"
    return (
      <div >
        <div
  ...
  export default LandingPageCristianV;
