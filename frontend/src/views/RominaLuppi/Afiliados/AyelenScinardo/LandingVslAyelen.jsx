...
const actually = [
 ...
 `Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/ayelen-scinardo/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "ayelen-scinardo"
const googleSheets = "https://script.google.com/macros/s/AKfycbxNOfdegeLEWKfXWr_xzQeWrvjgvEeQxpF5C-Nicgf0MMlgiMRrB-1O9HhBd6rgyQzg/exec"
const wppLink = "https://wa.me/+5491133341173?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491133341173"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
