...
const LandingPageAyelen = () => {
 
  const url = "/ayelen-scinardo/vsl?registered=true";
  const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbxNOfdegeLEWKfXWr_xzQeWrvjgvEeQxpF5C-Nicgf0MMlgiMRrB-1O9HhBd6rgyQzg/exec"
    return (
      <div >
        <div
  ...
  export default LandingPageAyelen;
