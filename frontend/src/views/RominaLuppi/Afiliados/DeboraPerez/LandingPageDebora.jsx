...
const LandingPageDebora = () => {
 
  const url = "/debora-perez/vsl?registered=true";
  const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbwDoZ4_ImAAk7MnJINhfPz-lWlKCjLOcDivJit90ZWYmSLjZVncI-fRqqDVAJWhwkY7/exec"
    return (
      <div >
        <div
  ...
  export default LandingPageDebora;
