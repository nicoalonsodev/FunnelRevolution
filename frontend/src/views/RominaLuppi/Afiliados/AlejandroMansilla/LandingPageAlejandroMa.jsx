...
const LandingPageAlejandroMa = () => {
 
  const url = "/alejandro-mansilla/vsl?registered=true";
  const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbxdCrOoDAme-ial90UhHa4Ui83ZWom0sDndTVPPrcGwJ7J647O6W7EM1mgH5jErUt5A/exec"
    return (
      <div >
        <div
  ...
  export default LandingPageAlejandroMa;
