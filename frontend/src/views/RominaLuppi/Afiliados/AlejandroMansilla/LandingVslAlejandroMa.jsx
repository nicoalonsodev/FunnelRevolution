...
const actually = [
 ...
 `Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/alejandro-mansilla/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "alejandro-mansilla"
const googleSheets = "https://script.google.com/macros/s/AKfycbxdCrOoDAme-ial90UhHa4Ui83ZWom0sDndTVPPrcGwJ7J647O6W7EM1mgH5jErUt5A/exec"
const wppLink = "https://wa.me/+5493512669789?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5493512669789"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslAlejandroMa;
