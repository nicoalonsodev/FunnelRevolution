...
const LandingPageBraulio = () => {
 
  const url = "/braulio-ramirez/vsl?registered=true";
  const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbw5oPtrcpOdHqNgYpxAjyR-0mkc6W_sxnLBsH4sxEc5b8OEjsjkYKLxqZ95hZJxsrU8/exec"
    return (
      <div >
        <div
  ...
  export default LandingPageBraulio;
