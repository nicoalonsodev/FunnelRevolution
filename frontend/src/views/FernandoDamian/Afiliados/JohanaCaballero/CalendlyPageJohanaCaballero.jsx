...
const CalendlyPageJohanaCaballero = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const calendlyLink = "https://calendly.com/johanagcaballeromoran/quiero-mi-acceso-a-revolution";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageJohanaCaballero
;