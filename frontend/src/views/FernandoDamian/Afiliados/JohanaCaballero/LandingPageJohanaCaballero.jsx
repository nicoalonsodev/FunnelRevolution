...
const LandingPageJohanaCaballero = () => {
 
const url = "/johana-caballero/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbwS3sf8rFbKIPu_5ELTEC6_JhYnFfaatm6vsq2JC5UsaQFKagWdImJBqnFPkW2Te-Wktg/exec"
  return (
    <div >
      <div
...
export default LandingPageJohanaCaballero;
