...
const LandingPagePabloB = () => {
 
const url = "/pablo-barboni/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbyJGPaAfJDzveevwpER35X8bkkAVujWnyJDfMfMYUDyB6iTRNBxI6Ogsq8rKDuzkSUY/exec"
  return (
    <div >
      <div
...
export default LandingPagePabloB;
