...
const LandingVslJeremiasVives = () => {
  ...
  const calendlyPage = "/jeremias-vives/calendly";
  const historyImages = [img1, img2, img3, img4];
  //const isRegistered = localStorage.getItem("isRegistered") === "true";
  const path = "jeremias-vives";
  const googleSheets = ""
const wppLink = "https://wa.me/+5493416524598?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5493416524598"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslJeremiasVives;
