...
const LandingVslCandelaFobello = () => {
  ...
  const calendlyPage = "/candela-fobello/calendly";
  const historyImages = [img1, img2, img3, img4];
  //const isRegistered = localStorage.getItem("isRegistered") === "true";
  const path = "candela-fobello";
  const googleSheets = ""
const wppLink = "https://wa.me/+5491162929812?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491162929812"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslCandelaFobello;
