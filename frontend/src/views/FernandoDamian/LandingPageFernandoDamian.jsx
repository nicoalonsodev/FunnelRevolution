...
const LandingPageFernandoDamian = () => {
 
const url = "/fernando-migliano/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbyD4qSFK9jE8zOsujhLw0G3-QrHJZ_SA-OJ5ycGjBEMfGxxwyhUAK26fr2Zllfd8-R5/exec"
  return (
    <div >
      <div
...
export default LandingPageFernandoDamian;
