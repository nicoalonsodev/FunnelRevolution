...
const LandingPageJoaquin = () => {
const url = "/joaquin-dominguez/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbwaL62WCv7cHVyTE-mnr3MaOwkOfzeDFY-XuZ74sC77SaOrV0r5K3CJsoNJ3_WrfhWG/exec"
  return (
    <div >
      <div
...
export default LandingPageJoaquin;
