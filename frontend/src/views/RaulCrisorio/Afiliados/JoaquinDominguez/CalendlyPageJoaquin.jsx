...
const CalendlyPageJoaquin = () => {
  ...
  const calendlyLink = "https://calendly.com/joaquindominguezlcf/llamada-de-iniciacion-a-revolution";
   const {
    actually,
    historyData,
    historyImages,
...
export default CalendlyPageJoaquin;
