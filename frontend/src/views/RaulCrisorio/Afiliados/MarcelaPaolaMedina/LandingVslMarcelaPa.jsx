...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/marcela-paola-medina/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "marcela-paola-medina"
const googleSheets = "https://script.google.com/macros/s/AKfycbylVuOIMN9LoBOLz3Ol0uQK8aZsaarysPG3wbgZIKqkjmo49HyBqxvWMc6a5TmatTO8Iw/exec"
const wppLink = "https://wa.me/+5493812189417?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5493812189417"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslMarcelaPa;
