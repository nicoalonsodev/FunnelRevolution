...
const LandingPageMarcelaPa = () => {
const url = "/marcela-paola-medina/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbylVuOIMN9LoBOLz3Ol0uQK8aZsaarysPG3wbgZIKqkjmo49HyBqxvWMc6a5TmatTO8Iw/exec"
  return (
    <div >
      <div
...
export default LandingPageMarcelaPa;
