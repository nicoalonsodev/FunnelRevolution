...
const LandingPageMelany = () => {
const url = "/melany-venditti/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbxBrY-dJiIGKfYrGSGociyFId8T8PS6li7XdJzKKrtOzff8T4sgb-191bSGpe5nZjXXDA/exec"
  return (
    <div >
      <div
...
export default LandingPageMelany;
