...
const LandingPageNicolas = () => {
const url = "/nicolas-balverdi/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbyicUDErSTRF8W3ZGYCE2x9_SByqWyBQdtQnYckV_2NJFb0glQ5I1gCE34uSe-v3q9-/exec"
  return (
    <div >
      <div
...
export default LandingPageNicolas;
