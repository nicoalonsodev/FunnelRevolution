...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/nicolas-balverdi/calendly";
const historyImages = [ img1, img2, img3, img4]
    const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "nicolas-balverdi"
const googleSheets = "https://script.google.com/macros/s/AKfycbyicUDErSTRF8W3ZGYCE2x9_SByqWyBQdtQnYckV_2NJFb0glQ5I1gCE34uSe-v3q9-/exec"
const wppLink = "https://wa.me/+5491171737554?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491171737554"
 const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslNicolas;
