...
const LandingPageRocioC = () => {
const url = "/carla-salomon/vsl?registered=true";
const googleSheetsUrl = "https://script.google.com/macros/s/AKfycbw_dAeUSi5FPDUH-r39B1ran7zYmPlA_KBtwiAveNqqIFbw8uYXzvTmCCROZlvFklo/exec"
  return (
    <div >
      <div
...
export default LandingPageRocioC;
