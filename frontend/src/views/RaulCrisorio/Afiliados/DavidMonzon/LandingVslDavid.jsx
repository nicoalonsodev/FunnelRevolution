...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/david-monzon/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "david-monzon"
const googleSheets = "https://script.google.com/macros/s/AKfycbyPhwtj_sJlQnNRYnDzXtxlKnLOQizpV3A9CQJhxUA6d6mo18qu5jhJ-mAvmm2RBb3sAQ/exec"
const wppLink = "https://wa.me/+5491131162995?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5491131162995"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslDavid;
