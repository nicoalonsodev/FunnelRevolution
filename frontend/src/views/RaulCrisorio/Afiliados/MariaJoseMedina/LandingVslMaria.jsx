...
const actually = [
 ...
 ` Acá los llamamos "los tres pilares" de este nuevo modelo de negocio…`,
  ...
  const calendlyPage = "/maria-medina/calendly";
const historyImages = [ img1, img2, img3, img4]
    //const isRegistered = localStorage.getItem("isRegistered") === "true";
const path = "maria-medina"
const googleSheets = "https://script.google.com/macros/s/AKfycbzwBNIbu_XKHtURRzVeghFDlmizk2PhxeM3w-Tse3HneJiBreWpOUKBhPe-A-Gbk8wg/exec"
const wppLink = "https://wa.me/+5492615468225?text=Hola%2C%20estoy%20interesado%20en%20tus%20servicios"
const wppNumber = "+5492615468225"
  const data = {
  historyPart1,
  historyPart2,
  historyPart3,
...
export default LandingVslMaria;
